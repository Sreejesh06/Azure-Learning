---
title: 02 - ACR Tasks & CI/CD
description: Move from manual Docker builds to teaching Azure how to build, test, and deploy your code automatically with ACR Tasks.
---

## Visual Flow (The Multi-Step Pipeline)

![Visual Flow](/images/lab02-flow.svg)

![ACR Tasks Architecture](/images/acr-tasks-architecture.png)
