...
![Azure Container Apps Lifecycle](https://learn.microsoft.com/en-us/azure/container-apps/media/application-lifecycle-management/azure-container-apps-lifecycle-update.png)
...
> **Note**: The examples in this unit use Azure CLI patterns. Validate command behavior in a non-production environment before you run lifecycle actions as part of an automated incident response workflow.
