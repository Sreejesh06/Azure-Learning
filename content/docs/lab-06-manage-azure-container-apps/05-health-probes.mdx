...
> **Note**: Probe support and the exact YAML schema can evolve. Use the examples in this unit as patterns, and validate the current schema in the Azure Container Apps documentation before you adopt these settings.
