...
Here are the 4 most important concepts you need to understand deeply.

## 1. The "Big Three" Pod Errors
...
## 2. `kubectl describe` (The Detective's Tool)
...
## 3. Getting Inside the Box (`kubectl exec`)
...
## 4. The "Missing Link": Services and Endpoints
