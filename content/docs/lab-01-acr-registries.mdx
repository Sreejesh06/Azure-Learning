---
title: 01 - ACR Registries & Artifacts
description: Provision a secure Azure Container Registry, build a Python Inference API container, and securely push it to the cloud.
---

## Visual Flow

![Visual Flow](/images/lab01-flow.svg)
