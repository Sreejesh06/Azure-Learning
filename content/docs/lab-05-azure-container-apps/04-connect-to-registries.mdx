---
title: 04 - Connect to Private Registries
description: Learn how to securely authenticate Azure Container Apps to private container registries using Managed Identities and credentials.
---
