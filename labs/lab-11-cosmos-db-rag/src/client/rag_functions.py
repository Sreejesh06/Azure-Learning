...
def store_document_chunk( document_id: str, chunk_id: str, content: str, metadata: dict = None, embedding: list = None ) -> dict:
...
def get_chunks_by_document(document_id: str, limit: int = 100) -> list:
    ...
    ORDER BY c.chunkIndex OFFSET 0 LIMIT @limit
    """
...
def search_chunks_by_metadata(
    ...
    FROM c 
    WHERE {where_clause} OFFSET 0 LIMIT @limit
    """
