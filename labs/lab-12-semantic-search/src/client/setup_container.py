...
def get_database():
    """Get a reference to the Cosmos DB database."""
    endpoint = os.environ.get("COSMOS_ENDPOINT")
    database_name = os.environ.get("COSMOS_DATABASE")
    key = os.environ.get("COSMOS_KEY") # NEW: Allow Key Auth for Control Plane operations
    ...
    if key:
        print("Using Master Key Authentication (Control Plane)")
        client = CosmosClient(endpoint, credential=key)
    else:
        print("Using Entra ID Authentication (Data Plane)")
